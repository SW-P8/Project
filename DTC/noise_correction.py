...
class NoiseCorrection:
    ...
    def correct_noisy_point(self, trajectory: Trajectory, point_id: int):
        ...
        nearest_anchor, _ = DistanceCalculator.find_nearest_neighbor_from_candidates(avg_point, self.gridsystem.route_skeleton, self.gridsystem.initialization_point, self.gridsystem.cell_size) 
       
        trajectory.points[point_id].set_coordinates(DistanceCalculator.convert_cell_to_point(self.gridsystem.initialization_point, nearest_anchor, self.gridsystem.cell_size))
